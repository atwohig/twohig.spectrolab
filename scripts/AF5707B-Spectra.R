...
dir_path = file.path("C:", "Users", "amy twohig", "OneDrive", "Documents", "HVEDI", "AF5707_5736", "AF5707B")

## reading the entire AF5707B folder
AF5707B_spectra = read_spectra(path = dir_path)
...
LOWER_5707B = AF5707B_spectra[1:15,]
MIDDLE_5707B = AF5707B_spectra[16:30,]
UPPER_5707B = AF5707B_spectra[31:45,]

## further separating into the 3 sections on each leaf: same format as above, 1-5, 6-10, 11-15
## FIRST SCAN (LOWER 0) IS BAD: TWO EXTRAS WERE NOT PLOTTED (LOWER 15 & 16)
LOWER_GROUP1 = LOWER_5707B[1:5,]
LOWER_GROUP2 = LOWER_5707B[6:10,]
LOWER_GROUP3 = LOWER_5707B[11:15,]

MIDDLE_GROUP1 = MIDDLE_5707B[1:5,]
MIDDLE_GROUP2 = MIDDLE_5707B[6:10,]
MIDDLE_GROUP3 = MIDDLE_5707B[11:15,]  

UPPER_GROUP1 = UPPER_5707B[1:5,]
UPPER_GROUP2 = UPPER_5707B[6:10,]
UPPER_GROUP3 = UPPER_5707B[11:15,]
...
plot(LOWER_5707B, lwd = 0.50, lty = 1, col = "grey25", main = "AF5707B Lower")
...
# 
# plot(MIDDLE_5707B, lwd = 0.50, lty = 1, col = "grey25", main = "AF5707B Middle")
...
# 
# 
# plot(UPPER_5707B, lwd = 0.50, lty = 1, col = "grey25", main = "AF5707B Upper")
